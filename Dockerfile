...
ARG REACT_APP_EXPORT_SCRAPE_DATA_TRIGGER_URL
ENV REACT_APP_EXPORT_SCRAPE_DATA_TRIGGER_URL=$REACT_APP_EXPORT_SCRAPE_DATA_TRIGGER_URL

ARG REACT_APP_AI_ASSISTANT_BASE_URL
ENV REACT_APP_AI_ASSISTANT_BASE_URL=$REACT_APP_AI_ASSISTANT_BASE_URL
